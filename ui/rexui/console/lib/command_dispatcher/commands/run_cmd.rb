module Commands
  ...
  def cmd_run(*args)
    ...
    transform_full_path = "#{ENV['POORTEGO_LOCAL_BASE']}/transforms"
    ...
    if ((File.exists?(transform_script)) == true)
      ...
      when 'entity'
        ...
        unless (driver.interface.working_values["Current Entity"].entity_type_id.nil?)
          entity_type = PoortegoEntityType.find(driver.interface.working_values["Current Entity"].entity_type_id)
